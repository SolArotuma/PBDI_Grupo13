...
## Problematicas:
1.  "Automatización del cambio de presión en el flujo del goteo intravenoso ante cambios repentinos." [1] [8] [9]  
2. "Dificultades en la recuperación de la función motora posterior a un accidente cerebrovascular isquémico mediante estrategias convencionales de rehabilitación" [4] [5] [6] [7]
